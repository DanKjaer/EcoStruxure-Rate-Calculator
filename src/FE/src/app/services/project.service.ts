...
export class ProjectService {
   ...
   */
  deleteProjectMember(project: Project, memberId: string): Promise<Project> {
    return firstValueFrom(this.http.put<Project>(`${this.apiUrl}/delete_member?&teamId=${memberId}`, project));
  }
