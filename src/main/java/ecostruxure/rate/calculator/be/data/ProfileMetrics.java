...
public record ProfileMetrics(BigDecimal hourlyRate, BigDecimal dayRate, BigDecimal annualCost, BigDecimal annualHours, BigDecimal costAllocation, BigDecimal hourAllocation) {
