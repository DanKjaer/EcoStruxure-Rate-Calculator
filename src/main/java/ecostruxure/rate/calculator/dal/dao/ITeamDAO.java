...
public interface ITeamDAO {
    ...
    void updateTeamRateCostHours(UUID teamId, BigDecimal hourlyRate, BigDecimal dayRate, BigDecimal totalAllocatedCost, BigDecimal totalAllocatedHours) throws SQLException;
