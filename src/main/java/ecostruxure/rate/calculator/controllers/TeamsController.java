...
public class TeamsController {
    ...
    @DeleteMapping("/{id}")
    public boolean deleteTeam(@PathVariable UUID id) throws Exception {
    ...
    @DeleteMapping("teamProfile/{id}")
    public boolean deleteTeamProfile(@PathVariable UUID id) throws Exception {
