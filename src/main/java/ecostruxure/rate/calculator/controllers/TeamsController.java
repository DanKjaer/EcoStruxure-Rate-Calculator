...
public class TeamsController {
    ...
    public boolean deleteTeamProfile(@RequestParam UUID teamProfileId, @RequestParam UUID teamId) throws Exception {
        return teamService.deleteTeamProfile(teamProfileId, teamId);
    }
}